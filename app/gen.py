...
def text_surface(text, max_width=BOARD_SIZE[0], max_height=BOARD_SIZE[1], font_size=40, color=WHITE,
                 font_fam="helvetica", color_key=BLUE, shadow=True):
    ...
    # set font face AND calculate line padding
...
def correct_surface(correct=True):
    ...
    if correct:
        text_surf = text_surface("CORRECT", 200, 100)
    else:
        text_surf = text_surface("INCORRECT", 200, 100)
